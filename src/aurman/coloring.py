...
class Colors:
    ...
    DARK_GRAY = lambda *x: Colors.concat_str("\033[90m", *x, "\033[22m\033[39m")
    LIGHT_RED = lambda *x: Colors.concat_str("\033[91m", *x, "\033[22m\033[39m")
    LIGHT_GREEN = lambda *x: Colors.concat_str("\033[92m", *x, "\033[22m\033[39m")
    LIGHT_YELLOW = lambda *x: Colors.concat_str("\033[93m", *x, "\033[22m\033[39m")
    LIGHT_BLUE = lambda *x: Colors.concat_str("\033[94m", *x, "\033[22m\033[39m")
    LIGHT_MAGENTA = lambda *x: Colors.concat_str("\033[95m", *x, "\033[22m\033[39m")
    LIGHT_CYAN = lambda *x: Colors.concat_str("\033[96m", *x, "\033[22m\033[39m")
    WHITE = lambda *x: Colors.concat_str("\033[97m", *x, "\033[22m\033[39m")
